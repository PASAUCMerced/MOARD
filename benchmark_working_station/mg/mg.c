...
static void P3gm(double u[], double v[], double r[], double a[4], double c[4], int n1, int n2, int n3);
...
// copied version used to warm up the program
static void P3gm(double u[], double v[], double r[],
                 double a[4], double c[4], int n1, int n2, int n3)
{
  int j, k;
